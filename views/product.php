...
<body>
                            ...
                            <div class="container">
                                <div class="sub-contenedor">
                                    ...
                                    <div class="entrada">
                                        ...
                                        <input type="number" id="price" class="form-control" placeholder="Precio">
                                    </div>
    ...
    <button type="button" class="nuevoRegistro" data-bs-toggle="modal" data-bs-target="#insertData">Nuevo producto</button>
